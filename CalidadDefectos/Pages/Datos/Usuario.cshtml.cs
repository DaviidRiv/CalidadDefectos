...
namespace CalidadDefectos.Pages.Datos
{
    ...
    public class UsuarioModel : PageModel
    {
        ...
        public UsuarioModel(CalidadDefectos.Data.CalidadDefectosContext context)
        {
            _context = context;
        }
        ...
        public SelectList? Estaciones { get; set; } //Genres
        [BindProperty(SupportsGet = true)]
        public string? ListaEstaciones { get; set; } //MovieGenre
